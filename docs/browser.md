...
```html
<script src="https://unpkg.com/@samline/ticker1.0.0/dist/browser/global.global.js"></script>
<link rel="stylesheet" href="https://unpkg.com/@samline/ticker1.0.0/dist/style.css">
...
```html
<script src="https://cdn.jsdelivr.net/npm/@samline/ticker1.0.0/dist/browser/global.global.js"></script>
```
...
```html
<script type="module">
  import { enhance } from 'https://unpkg.com/@samline/ticker1.0.0/dist/browser/global.global.js'
