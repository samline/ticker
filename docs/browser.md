...
```html
<script src="https://unpkg.com/@samline/ticker@1.0.7/dist/browser/index.global.js"></script>
...
```html
<script src="https://cdn.jsdelivr.net/npm/@samline/ticker@1.0.7/dist/browser/index.global.js"></script>
```
...
```html
<script type="module">
  import { enhance } from 'https://unpkg.com/@samline/ticker@1.0.7/dist/browser/index.global.js'
