...
```html
<script src="https://unpkg.com/@samline/ticker/dist/browser/global.js"></script>
...
```html
<script src="https://cdn.jsdelivr.net/npm/@samline/ticker/dist/browser/global.js"></script>
```
...
```html
<script type="module">
  import { enhance } from 'https://unpkg.com/@samline/ticker/dist/browser/global.js'
