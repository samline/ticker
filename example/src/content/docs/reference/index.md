...
- [Styling](/ticker/reference/styling/) — generated DOM, data attributes, classes, CSS variables, and animation ownership.
- [Recipes](/ticker/reference/examples/) — common initialization, updates, dynamic content, multiple tickers, and cleanup.

The package has no runtime or peer dependencies. Every supported integration is built on native DOM APIs and the same Vanilla controller.
